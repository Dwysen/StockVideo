...
extension JPVideoPlayerDemoVC_Setting {
    ...
    func goWechat() {
        ...
        let img =  JPQRCodeTool.generateCode(for: "http://qm.qq.com/cgi-bin/qm/qr?k=iOcOSuD9eYS7kdmcclRFnWFkHZbGIjdm", with: kQRCodeCorrectionLevel.qrCodeCorrectionLevelNormal, sizeType: kQRCodeSizeType.qrCodeSizeTypeNormal, customSizeDelta: 0, drawType: kQRCodeDrawType.qrCodeDrawTypeCircle, gradientType: kQRCodeGradientType.qrCodeGradientTypeDiagonal, gradientColors: colors)
        imv.image = img
